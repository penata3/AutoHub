namespace AutoHub.Web.Areas.Identity.Pages.Account
{
    ...
    public class RegisterModel : PageModel
    {
        ...
        public class InputModel
        {
            ...
            [YearValidatorForUserRegistration(18,ErrorMessage = "Invalid Age")]
        ...
        public async Task<IActionResult> OnPostAsync(string returnUrl = null)
        {
            ...
            {
                var user = new ApplicationUser { UserName = this.Input.Email, Email = this.Input.Email, DateOfBirth = this.Input.DateOfBirth };
